...
import com.github.drednote.telegramstatemachine.springstarter.config.TestTelegramStateMachineAdapter;
import com.github.drednote.telegramstatemachine.springstarter.jpa.config.TelegramStateMachinePersisterAutoConfiguration;
...
@Import({
    TelegramStateMachineAutoConfiguration.class,
    TelegramStateMachinePersisterAutoConfiguration.class,
    TestTelegramStateMachineAdapter.class
})
